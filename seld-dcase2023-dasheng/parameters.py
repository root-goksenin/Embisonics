...
def get_params(argv='1'):
    ...
    params = dict(
        ...
        pretrained_model_weights='/projects/0/prjs1338/seld/tau2021_dasheng_saved_models/2_1_dev_split0_accdoa_foa_model.h5',

        # INPUT PATH
        dataset_dir='/projects/0/prjs1338/seld/tau2021',

        # OUTPUT PATHS
        feat_label_dir='/projects/0/prjs1338/seld/tau2021_labels_dasheng',
 
        model_dir='/projects/0/prjs1338/seld/tau2021_saved_models_dasheng',            # Dumps the trained models and training curves in this folder
        dcase_output_dir='/projects/0/prjs1338/seld/tau2021_results_dasheng',    # recording-wise results are dumped in this path.
        ...
        mono_encoder='dasheng-base',            # 'gram' | 'dasheng-base' | 'dasheng-large' | 'atst'
        inject_spatial_tokens='True',   # 'True' (ours) | 'False' (mono-only) | 'Learn' (conv baseline)


        # Dims for the 'Learn' conv front-end (baseline iii).
        # Match the pretrained spatial stream so fused dims are identical.
        learnt_token_dim=384,           # = SphereV4.encoder_embedding_dim
        learnt_n_freq=8,                # = SphereV4.p_f_dim (128 / fshape=16)

        # Mono backbone ids / paths (only the selected one is loaded)
        mono_ckpts=dict(
            gram='labhamlet/gramt-mono',
            dasheng_base='mispeech/dasheng-base',
            dasheng_large='mispeech/dasheng-large',
    ...
    # --- mono-encoder sweep, all with OURS (inject='True') ---
        ...
        params['dataset'] = 'foa'
        params['mono_encoder'] = 'dasheng-base'
        params['inject_spatial_tokens'] = 'True'
        params['multi_accdoa'] = False

    elif argv == '32':
        params['dataset'] = 'foa'
        params['mono_encoder'] = 'dasheng-large'
        params['inject_spatial_tokens'] = 'True'
        params['multi_accdoa'] = False
