...
# weights=/projects/0/prjs1338/embisonics_mae_saved_try_equiv_no_gate_fr/InChannels=7/Fraction=None/CleanDataFraction=None/Model=GRAM-T/ModelSize=base/LR=0.0004/BatchSize=8/NrSamples=None/Patching=frame/InputL=500/step=10000-v2.ckpt
# model_name=hear_configs.SPHERE_v2_semantic
# strategy=raw
