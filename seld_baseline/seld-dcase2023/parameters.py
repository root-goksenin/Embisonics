...
def get_params(argv='1'):
    ...
    params = dict(
        ...
        pretrained_model_weights='/projects/0/prjs1338/seld/tau2021_saved_models/2_1_dev_split0_accdoa_foa_model.h5',

        # INPUT PATH
        dataset_dir='/projects/0/prjs1338/seld_asm_baseline/tau2021',

        # OUTPUT PATHS
        feat_label_dir='/projects/0/prjs1338/seld_asm_baseline/tau2021_labels_baseline',
 
        model_dir='/projects/0/prjs1338/seld_asm_baseline/tau2021_saved_models_baseline',            # Dumps the trained models and training curves in this folder
        dcase_output_dir='/projects/0/prjs1338/seld_asm_baseline/tau2021_results_baseline',    # recording-wise results are dumped in this path.
