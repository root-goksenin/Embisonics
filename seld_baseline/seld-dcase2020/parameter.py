...
def get_params(argv='1'):
    ...
    params = dict(
        ...
        dataset_dir='/projects/0/prjs1338/seld_asm_baseline/tau2020',
        feat_label_dir='/projects/0/prjs1338/seld_asm_baseline/tau2020_labels_baseline',
        model_dir='/projects/0/prjs1338/seld_asm_baseline/tau2020_saved_models_baseline',            # Dumps the trained models and training curves in this folder
        dcase_dir='/projects/0/prjs1338/seld_asm_baseline/tau2020_results_baseline',    # recording-wise results are dumped in this path.
