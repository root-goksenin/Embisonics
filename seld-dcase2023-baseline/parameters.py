...
def get_params(argv='1'):
    ...
    params = dict(
        ...
        # INPUT PATH
        dataset_dir='/projects/0/prjs1338/seld_baseline/starss2023',

        # OUTPUT PATHS
        feat_label_dir='/projects/0/prjs1338/seld_baseline/starss2023_baseline_labels',
 
        model_dir='/projects/0/prjs1338/seld_baseline/starss2023_baseline_models',            # Dumps the trained models and training curves in this folder
        dcase_output_dir='/projects/0/prjs1338/seld_baseline/starss2023_baseline_results',    # recording-wise results are dumped in this path.
