# Parameters used in the feature extraction, neural network model, and training the seld_baselinenet can be changed here.
#
...
def get_params(argv='1'):
    ...
    params = dict(
        ...
        dataset_dir='/projects/0/prjs1338/seld_baseline/starss2024/',


        feat_label_dir='/projects/0/prjs1338/seld_baseline/starss2024/seld_baseline_feat_label/',

        model_dir='/projects/0/prjs1338/seld_baseline/starss2024_baseline_models',  # Dumps the trained models and training curves in this folder
        dcase_output_dir='/projects/0/prjs1338/seld_baseline/starss2024_baseline_result',  # recording-wise results are dumped in this path.
